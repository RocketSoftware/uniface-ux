    ...
    describe("Create widget", function () {
        ...
        it("constructor", function () {
            try {
                ...
                const widgetClass = tester.getWidgetClass();
                assert(widgetClass.defaultProperties.classes['u-select'], "Class is not defined");
            } catch (e) {
    ...
    describe("dataUpdate", function () {
        ...
        it("show label", function (done) {
            ...
            setTimeout(function () {
                ...
                assert.equal(labelText, selectFieldLabel);//Check for visibility
                assert(!labelElement.hasAttribute("hidden"), "Failed to show the label text");
                assert.equal(labelElement.getAttribute("slot"), "label");
                done();

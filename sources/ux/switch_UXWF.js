...
import { Element, SlottedError, StyleClass, Trigger } from "./workers_UXWF.js";
import { HtmlAttribute, HtmlAttributeNumber, HtmlAttributeBoolean, SlottedElement, HtmlValueAttributeBoolean } from "./workers_UXWF.js";
...
export class Switch_UXWF extends Widget_UXWF {
    ...
    /**
    * PRIVATE SETTER: SwitchSlottedError
        ...
        refresh(widgetInstance) {
            ...
            if (errorElement) {
                if (formatError || error) {
                    //Check if there is any element for the same slot then hide 
                    if (this.selectorUsingSameErrorSlot) {
    ...
    **/
    ...
    onConnect(widgetElement) {
        ...
        return super.onConnect(widgetElement);
    }
}

...
(function () {
  ...
  /**
   * Mock implementation of object definition for testing nested structures.
   * Can be used for both collection and occurrence entities.
   */
  class MockEntityDefinition {
     ...
     * Override in derived mocks to test occurrence property handling.
     */
     ...
     * Override in derived mocks to capture calls during testing.
     */
  ...
  /**
   * Helper function to create a skeleton element.
   */
